...
*DefaultApi* | [**downloadCheck**](docs/Api/DefaultApi.md#downloadcheck) | **GET** /checks/{check_id}/download | Download a check raw data
...
*DefaultApi* | [**downloadSignedEvidenceFile**](docs/Api/DefaultApi.md#downloadsignedevidencefile) | **GET** /workflow_runs/{workflow_run_id}/signed_evidence_file | Retrieves the signed evidence file for the designated Workflow Run
