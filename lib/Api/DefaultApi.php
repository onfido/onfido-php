...
class DefaultApi
{
     ...
     * @param  \Onfido\Model\CompleteTaskRequest $complete_task_request complete_task_request (required)
     ...
     * @return void
     */
    public function completeTask($workflow_run_id, $task_id, $complete_task_request, string $contentType = self::contentTypes['completeTask'][0])
    {
        $this->completeTaskWithHttpInfo($workflow_run_id, $task_id, $complete_task_request, $contentType);
    }
     ...
     * @param  string $workflow_run_id The unique identifier of the Workflow Run to which the Task belongs. (required)
     * @param  string $task_id The identifier of the Task you want to complete. (required)
     * @param  \Onfido\Model\CompleteTaskRequest $complete_task_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['completeTask'] to see the possible values for this operation
     *
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function completeTaskWithHttpInfo($workflow_run_id, $task_id, $complete_task_request, string $contentType = self::contentTypes['completeTask'][0])
    {
        $request = $this->completeTaskRequest($workflow_run_id, $task_id, $complete_task_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function completeTaskAsync($workflow_run_id, $task_id, $complete_task_request, string $contentType = self::contentTypes['completeTask'][0])
    {
        return $this->completeTaskAsyncWithHttpInfo($workflow_run_id, $task_id, $complete_task_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function completeTaskAsyncWithHttpInfo($workflow_run_id, $task_id, $complete_task_request, string $contentType = self::contentTypes['completeTask'][0])
    {
        $returnType = '';
        $request = $this->completeTaskRequest($workflow_run_id, $task_id, $complete_task_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function completeTaskRequest($workflow_run_id, $task_id, $complete_task_request, string $contentType = self::contentTypes['completeTask'][0])
    {
        ...
        if ($complete_task_request === null || (is_array($complete_task_request) && count($complete_task_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $complete_task_request when calling completeTask'
            );
        }
     ...
     *
     * @param  \Onfido\Model\WatchlistMonitor $watchlist_monitor watchlist_monitor (required)
     ...
     */
    public function createWatchlistMonitor($watchlist_monitor, string $contentType = self::contentTypes['createWatchlistMonitor'][0])
    {
        list($response) = $this->createWatchlistMonitorWithHttpInfo($watchlist_monitor, $contentType);
        return $response;
    }
     ...
     * Creates a new monitor for the applicant
     *
     * @param  \Onfido\Model\WatchlistMonitor $watchlist_monitor (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createWatchlistMonitor'] to see the possible values for this operation
     *
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function createWatchlistMonitorWithHttpInfo($watchlist_monitor, string $contentType = self::contentTypes['createWatchlistMonitor'][0])
    {
        $request = $this->createWatchlistMonitorRequest($watchlist_monitor, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWatchlistMonitorAsync($watchlist_monitor, string $contentType = self::contentTypes['createWatchlistMonitor'][0])
    {
        return $this->createWatchlistMonitorAsyncWithHttpInfo($watchlist_monitor, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWatchlistMonitorAsyncWithHttpInfo($watchlist_monitor, string $contentType = self::contentTypes['createWatchlistMonitor'][0])
    {
        $returnType = '\Onfido\Model\WatchlistMonitor';
        $request = $this->createWatchlistMonitorRequest($watchlist_monitor, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createWatchlistMonitorRequest($watchlist_monitor, string $contentType = self::contentTypes['createWatchlistMonitor'][0])
    {

        // verify the required parameter 'watchlist_monitor' is set
        if ($watchlist_monitor === null || (is_array($watchlist_monitor) && count($watchlist_monitor) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $watchlist_monitor when calling createWatchlistMonitor'
            );
        }
        ...
        // for model (json/xml)
        if (isset($watchlist_monitor)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($watchlist_monitor));
            } else {
                $httpBody = $watchlist_monitor;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation forceNewRecordCreation
     *
     * Force new report creation (BETA)
     *
     * @param  string $monitor_id monitor_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['forceNewRecordCreation'] to see the possible values for this operation
     *
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Onfido\Model\Applicant|\Onfido\Model\Error
     */
    public function forceNewRecordCreation($monitor_id, string $contentType = self::contentTypes['forceNewRecordCreation'][0])
    {
        list($response) = $this->forceNewRecordCreationWithHttpInfo($monitor_id, $contentType);
        return $response;
    }

    /**
     * Operation forceNewRecordCreationWithHttpInfo
     *
     * Force new report creation (BETA)
     *
     * @param  string $monitor_id (required)
     ...
     * @return array of \Onfido\Model\Applicant|\Onfido\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function forceNewRecordCreationWithHttpInfo($monitor_id, string $contentType = self::contentTypes['forceNewRecordCreation'][0])
    {
        $request = $this->forceNewRecordCreationRequest($monitor_id, $contentType);
    ...
    /**
     * Operation forceNewRecordCreationAsync
     *
     * Force new report creation (BETA)
     *
     * @param  string $monitor_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forceNewRecordCreationAsync($monitor_id, string $contentType = self::contentTypes['forceNewRecordCreation'][0])
    {
        return $this->forceNewRecordCreationAsyncWithHttpInfo($monitor_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation forceNewRecordCreationAsyncWithHttpInfo
     *
     * Force new report creation (BETA)
     *
     * @param  string $monitor_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forceNewRecordCreationAsyncWithHttpInfo($monitor_id, string $contentType = self::contentTypes['forceNewRecordCreation'][0])
    {
        $returnType = '\Onfido\Model\Applicant';
        $request = $this->forceNewRecordCreationRequest($monitor_id, $contentType);
    ...
    /**
     * Create request for operation 'forceNewRecordCreation'
     *
     * @param  string $monitor_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['forceNewRecordCreation'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function forceNewRecordCreationRequest($monitor_id, string $contentType = self::contentTypes['forceNewRecordCreation'][0])
    {

        // verify the required parameter 'monitor_id' is set
        if ($monitor_id === null || (is_array($monitor_id) && count($monitor_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $monitor_id when calling forceNewRecordCreation'
            );
        }
     ...
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Onfido\Model\LiveoVideosList|\Onfido\Model\Error
     */
     ...
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Onfido\Model\LiveoVideosList|\Onfido\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listLiveVideosWithHttpInfo($applicant_id, string $contentType = self::contentTypes['listLiveVideos'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Onfido\Model\LiveoVideosList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Onfido\Model\LiveoVideosList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Onfido\Model\LiveoVideosList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Onfido\Model\LiveoVideosList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Onfido\Model\WatchlistMonitorMatch[]
     */
     ...
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Onfido\Model\WatchlistMonitorMatch[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listWatchlistMonitorMatchesWithHttpInfo($monitor_id, string $contentType = self::contentTypes['listWatchlistMonitorMatches'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Onfido\Model\WatchlistMonitorMatch[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Onfido\Model\WatchlistMonitorMatch[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Onfido\Model\WatchlistMonitorMatch[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Onfido\Model\WatchlistMonitorMatch[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Onfido\Model\WatchlistMonitorMatch[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  bool $include_deleted Whether to also include deleted (inactive) monitors. (optional, default to false)
     ...
     * List Workflow Runs.
     *
     * @param  int $page The number of the page to be retrieved. If not specified, defaults to 1. (optional, default to 1)
     * @param  string $status A list of comma separated status values to filter the results. Possible values are &#39;processing&#39;, &#39;awaiting_input&#39;, &#39;approved&#39;, &#39;declined&#39;, &#39;review&#39;, &#39;abandoned&#39; and &#39;error&#39;. (optional)
    ...
    /**
     * Operation updateMonitorMatch
     *
     * Update the status of the given matches.
     *
     * @param  string $monitor_id monitor_id (required)
     * @param  \Onfido\Model\UpdateMonitorMatchRequest $update_monitor_match_request update_monitor_match_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateMonitorMatch'] to see the possible values for this operation
     *
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateMonitorMatch($monitor_id, $update_monitor_match_request, string $contentType = self::contentTypes['updateMonitorMatch'][0])
    {
        $this->updateMonitorMatchWithHttpInfo($monitor_id, $update_monitor_match_request, $contentType);
    }

    /**
     * Operation updateMonitorMatchWithHttpInfo
     *
     * Update the status of the given matches.
     *
     * @param  string $monitor_id (required)
     * @param  \Onfido\Model\UpdateMonitorMatchRequest $update_monitor_match_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateMonitorMatch'] to see the possible values for this operation
     *
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateMonitorMatchWithHttpInfo($monitor_id, $update_monitor_match_request, string $contentType = self::contentTypes['updateMonitorMatch'][0])
    {
        $request = $this->updateMonitorMatchRequest($monitor_id, $update_monitor_match_request, $contentType);
    ...
    /**
     * Operation updateMonitorMatchAsync
     *
     * Update the status of the given matches.
     *
     * @param  string $monitor_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMonitorMatchAsync($monitor_id, $update_monitor_match_request, string $contentType = self::contentTypes['updateMonitorMatch'][0])
    {
        return $this->updateMonitorMatchAsyncWithHttpInfo($monitor_id, $update_monitor_match_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateMonitorMatchAsyncWithHttpInfo
     *
     * Update the status of the given matches.
     *
     * @param  string $monitor_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMonitorMatchAsyncWithHttpInfo($monitor_id, $update_monitor_match_request, string $contentType = self::contentTypes['updateMonitorMatch'][0])
    {
        $returnType = '';
        $request = $this->updateMonitorMatchRequest($monitor_id, $update_monitor_match_request, $contentType);
    ...
    /**
     * Create request for operation 'updateMonitorMatch'
     *
     * @param  string $monitor_id (required)
     * @param  \Onfido\Model\UpdateMonitorMatchRequest $update_monitor_match_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateMonitorMatch'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateMonitorMatchRequest($monitor_id, $update_monitor_match_request, string $contentType = self::contentTypes['updateMonitorMatch'][0])
    {

        // verify the required parameter 'monitor_id' is set
        if ($monitor_id === null || (is_array($monitor_id) && count($monitor_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $monitor_id when calling updateMonitorMatch'
            );
        }

        // verify the required parameter 'update_monitor_match_request' is set
        if ($update_monitor_match_request === null || (is_array($update_monitor_match_request) && count($update_monitor_match_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_monitor_match_request when calling updateMonitorMatch'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_monitor_match_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_monitor_match_request));
            } else {
                $httpBody = $update_monitor_match_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  string $side The side of the document, if applicable. The possible values are front and back (optional)
     * @param  \Onfido\Model\CountryCodes $issuing_country The issuing country of the document, a 3-letter ISO code. (optional)
     ...
     * @param  \Onfido\Model\LocationBuilder $location location (optional)
     ...
     * @param  \Onfido\Model\CountryCodes $issuing_country The issuing country of the document, a 3-letter ISO code. (optional)
     * @param  bool $validate_image_quality Defaults to false. When true the submitted image will undergo an image quality validation which may take up to 5 seconds. (optional)
     * @param  \Onfido\Model\LocationBuilder $location (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['uploadDocument'] to see the possible values for this operation
     *
     * @throws \Onfido\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * Upload ID photo
     *
     * @param  string $applicant_id The ID of the applicant whose ID photo is being uploaded. (optional)
     * @param  \SplFileObject $file The file to be uploaded. (optional)
     ...
     * Upload live photo
     *
     * @param  string $applicant_id The ID of the applicant whose live photo is being uploaded. (optional)
     * @param  \SplFileObject $file The file to be uploaded. (optional)
