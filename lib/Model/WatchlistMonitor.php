...
class WatchlistMonitor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier for the monitor.
     *
     * @return self
     */
     ...
     * Sets report_name
     *
     * @param string $report_name The name of the report type the monitor creates. Can be either \"watchlist_standard\" or \"watchlist_aml\".
     *
     * @return self
     */
