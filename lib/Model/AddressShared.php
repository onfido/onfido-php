...
/**
 * AddressShared Class Doc Comment
 *
 * @category Class
 * @package  Onfido
 * @author   OpenAPI Generator team
 ...
 */
class AddressShared implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'address_shared';
    ...
    */
    ...
    public function setLine1($line1)
    {
        ...
        if (!is_null($line1) && (!preg_match("/^[^!$%^*=<>]*$/", ObjectSerializer::toString($line1)))) {
            throw new \InvalidArgumentException("invalid value for \$line1 when calling AddressShared., must conform to the pattern /^[^!$%^*=<>]*$/.");
        }
    ...
    public function setLine2($line2)
    {
        ...
        if (!is_null($line2) && (!preg_match("/^[^!$%^*=<>]*$/", ObjectSerializer::toString($line2)))) {
            throw new \InvalidArgumentException("invalid value for \$line2 when calling AddressShared., must conform to the pattern /^[^!$%^*=<>]*$/.");
        }
    ...
    public function setLine3($line3)
    {
        ...
        if (!is_null($line3) && (!preg_match("/^[^!$%^*=<>]*$/", ObjectSerializer::toString($line3)))) {
            throw new \InvalidArgumentException("invalid value for \$line3 when calling AddressShared., must conform to the pattern /^[^!$%^*=<>]*$/.");
        }
