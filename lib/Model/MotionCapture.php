...
/**
 * MotionCapture Class Doc Comment
 *
 * @category Class
 * @package  Onfido
 * @author   OpenAPI Generator team
 ...
 */
class MotionCapture implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'motion_capture';
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier for the motion capture.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The date and time at which the motion capture was uploaded.
     *
     * @return self
     */
     ...
     * Sets download_href
     *
     * @param string|null $download_href The uri that can be used to download the motion capture.
     *
     * @return self
     */
