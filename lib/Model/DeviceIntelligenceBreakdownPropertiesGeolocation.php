...
class DeviceIntelligenceBreakdownPropertiesGeolocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets city
     *
     * @param string|null $city City location of the IP address.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region Region location of the IP address.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param \Onfido\Model\CountryCodes|null $country Country location of the IP address in a three letter format.
     *
     * @return self
     */
