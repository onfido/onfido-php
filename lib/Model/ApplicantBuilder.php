...
/**
 * ApplicantBuilder Class Doc Comment
 *
 * @category Class
 * @package  Onfido
 * @author   OpenAPI Generator team
 ...
 */
class ApplicantBuilder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'applicant_builder';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[^!#$%*=<>;{}\"]*$/", $this->container['first_name'])) {
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((!preg_match("/^[^!#$%*=<>;{}\"]*$/", ObjectSerializer::toString($first_name)))) {
            throw new \InvalidArgumentException("invalid value for \$first_name when calling ApplicantBuilder., must conform to the pattern /^[^!#$%*=<>;{}\"]*$/.");
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((!preg_match("/^[^!#$%*=<>;{}\"]*$/", ObjectSerializer::toString($last_name)))) {
            throw new \InvalidArgumentException("invalid value for \$last_name when calling ApplicantBuilder., must conform to the pattern /^[^!#$%*=<>;{}\"]*$/.");
        }
