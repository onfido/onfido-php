    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((!preg_match("/^[^!#$%*=<>;{}\"]*$/", ObjectSerializer::toString($first_name)))) {
            throw new \InvalidArgumentException("invalid value for \$first_name when calling Applicant., must conform to the pattern /^[^!#$%*=<>;{}\"]*$/.");
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((!preg_match("/^[^!#$%*=<>;{}\"]*$/", ObjectSerializer::toString($last_name)))) {
            throw new \InvalidArgumentException("invalid value for \$last_name when calling Applicant., must conform to the pattern /^[^!#$%*=<>;{}\"]*$/.");
        }
