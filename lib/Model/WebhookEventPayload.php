...
class WebhookEventPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook_event_payload';
    ...
    */
     ...
     * Sets action
     *
     * @param \Onfido\Model\WebhookEventType|null $action The event that triggered this webhook.
     *
     * @return self
     */
     ...
     * Gets object
     *
     * @return \Onfido\Model\WebhookEventPayloadObject|null
     */
     ...
     * Sets object
     *
     * @param \Onfido\Model\WebhookEventPayloadObject|null $object object
     *
     * @return self
     */
