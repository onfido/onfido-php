...
/**
 * LiveoVideosList Class Doc Comment
 *
 * @category Class
 * @package  Onfido
 * @author   OpenAPI Generator team
 ...
 */
class LiveoVideosList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Liveo_Videos_list';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['live_videos'] === null) {
            $invalidProperties[] = "'live_videos' can't be null";
        }
     ...
     * Sets live_videos
     *
     * @param \Onfido\Model\LiveVideo[] $live_videos live_videos
     *
     * @return self
     */
