...
/**
 * ApplicantConsent Class Doc Comment
 *
 * @category Class
 * @package  Onfido
 * @author   OpenAPI Generator team
 ...
 */
class ApplicantConsent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'applicant_consent';
    ...
    */
     ...
     * Sets granted_at
     *
     * @param \DateTime $granted_at The date and time when this applicant consent was granted, if not granted the value is nil.
     *
     * @return self
     */
