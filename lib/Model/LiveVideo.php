 ...
 */
class LiveVideo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets challenge
     *
     * @param array<string,object>[]|null $challenge Challenge the end user was asked to perform during the video recording.
     *
     * @return self
     */
