...
class IDPhotosList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id_photos' => '\Onfido\Model\IdPhoto[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['id_photos'] === null) {
            $invalidProperties[] = "'id_photos' can't be null";
        }
     ...
     * Sets id_photos
     *
     * @param \Onfido\Model\IdPhoto[] $id_photos id_photos
     *
     * @return self
     */
