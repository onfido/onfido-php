...
/**
 * DocumentWithDriverVerificationReportAllOfProperties Class Doc Comment
 *
 * @category Class
 * @package  Onfido
 * @author   OpenAPI Generator team
 ...
 */
class DocumentWithDriverVerificationReportAllOfProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'document_with_driver_verification_report_allOf_properties';
    ...
    */
    ...
    public function setNistIdentityEvidenceStrength($nist_identity_evidence_strength)
    {
        ...
        if (!in_array($nist_identity_evidence_strength, $allowedValues, true)) {
            $nist_identity_evidence_strength = self::NIST_IDENTITY_EVIDENCE_STRENGTH_UNKNOWN_DEFAULT_OPEN_API;
        }
    ...
    public function setHasIssuanceConfirmation($has_issuance_confirmation)
    {
        ...
        if (!in_array($has_issuance_confirmation, $allowedValues, true)) {
            $has_issuance_confirmation = self::HAS_ISSUANCE_CONFIRMATION_UNKNOWN_DEFAULT_OPEN_API;
        }
    ...
    public function setSecurityTier($security_tier)
    {
        ...
        if (!in_array($security_tier, $allowedValues, true)) {
            $security_tier = self::SECURITY_TIER_UNKNOWN_DEFAULT_OPEN_API;
        }
    ...
    /**
     * Gets drivers_licence
     *
     * @return bool|null
     */
    public function getDriversLicence()
    {
        return $this->container['drivers_licence'];
    }

    /**
     * Sets drivers_licence
     *
     * @param bool|null $drivers_licence True for **non-restricted** driving licences
     *
     * @return self
     */
    public function setDriversLicence($drivers_licence)
    {
        if (is_null($drivers_licence)) {
            throw new \InvalidArgumentException('non-nullable drivers_licence cannot be null');
        }
        $this->container['drivers_licence'] = $drivers_licence;

        return $this;
    }

    /**
     * Gets restricted_licence
     *
     * @return bool|null
     */
    public function getRestrictedLicence()
    {
        return $this->container['restricted_licence'];
    }

    /**
     * Sets restricted_licence
     *
     * @param bool|null $restricted_licence True for **limited/restricted** driving license, including learner's permits
     *
     * @return self
     */
    public function setRestrictedLicence($restricted_licence)
    {
        if (is_null($restricted_licence)) {
            throw new \InvalidArgumentException('non-nullable restricted_licence cannot be null');
        }
        $this->container['restricted_licence'] = $restricted_licence;

        return $this;
    }

    /**
     * Gets raw_licence_category
     *
     * @return string|null
     */
    public function getRawLicenceCategory()
    {
        return $this->container['raw_licence_category'];
    }

    /**
     * Sets raw_licence_category
     *
     * @param string|null $raw_licence_category Underlying, non-normalised, licence category (e.g. \"Junior operators license\")
     *
     * @return self
     */
    public function setRawLicenceCategory($raw_licence_category)
    {
        if (is_null($raw_licence_category)) {
            throw new \InvalidArgumentException('non-nullable raw_licence_category cannot be null');
        }
        $this->container['raw_licence_category'] = $raw_licence_category;

        return $this;
    }

    /**
     * Gets raw_vehicle_classes
     *
     * @return string|null
     */
    public function getRawVehicleClasses()
    {
        return $this->container['raw_vehicle_classes'];
    }

    /**
     * Sets raw_vehicle_classes
     *
     * @param string|null $raw_vehicle_classes Comma-separated vehicle classes that the user is qualified for
     *
     * @return self
     */
    public function setRawVehicleClasses($raw_vehicle_classes)
    {
        if (is_null($raw_vehicle_classes)) {
    ...
    /**
     * Gets vehicle_class_details
     *
     * @return \Onfido\Model\DocumentWithDriverVerificationReportAllOfPropertiesAllOfVehicleClassDetailsInner[]|null
     */
    public function getVehicleClassDetails()
    {
        return $this->container['vehicle_class_details'];
    }

    /**
     * Sets vehicle_class_details
     *
     * @param \Onfido\Model\DocumentWithDriverVerificationReportAllOfPropertiesAllOfVehicleClassDetailsInner[]|null $vehicle_class_details Detailed classes/categories information
     *
     * @return self
     */
    public function setVehicleClassDetails($vehicle_class_details)
    {
        if (is_null($vehicle_class_details)) {
            throw new \InvalidArgumentException('non-nullable vehicle_class_details cannot be null');
        }
        $this->container['vehicle_class_details'] = $vehicle_class_details;

        return $this;
    }

    /**
     * Gets passenger_vehicle
     *
     * @return \Onfido\Model\DocumentWithDriverVerificationReportAllOfPropertiesAllOfPassengerVehicle|null
     */
    public function getPassengerVehicle()
    {
        return $this->container['passenger_vehicle'];
    }

    /**
     * Sets passenger_vehicle
     *
     * @param \Onfido\Model\DocumentWithDriverVerificationReportAllOfPropertiesAllOfPassengerVehicle|null $passenger_vehicle passenger_vehicle
     *
     * @return self
     */
    public function setPassengerVehicle($passenger_vehicle)
    {
        if (is_null($passenger_vehicle)) {
            throw new \InvalidArgumentException('non-nullable passenger_vehicle cannot be null');
        }
        $this->container['passenger_vehicle'] = $passenger_vehicle;
