...
class IdentityEnhancedBreakdown implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ssn' => '\Onfido\Model\IdrSsnBreakdown',
        'ssn1' => '\Onfido\Model\IdrSsnBreakdown'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ssn1', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets ssn
     *
     * @return \Onfido\Model\IdrSsnBreakdown|null
     */
     ...
     * Sets ssn
     *
     * @param \Onfido\Model\IdrSsnBreakdown|null $ssn ssn
     *
     * @return self
     */
    ...
    {
        return $this->container['ssn1'];
    }

    /**
     * Sets ssn1
     *
     * @param \Onfido\Model\IdrSsnBreakdown|null $ssn1 ssn1
     *
     * @return self
     */
    ...
    {
        if (is_null($ssn1)) {
            throw new \InvalidArgumentException('non-nullable ssn1 cannot be null');
        }
        $this->container['ssn1'] = $ssn1;
