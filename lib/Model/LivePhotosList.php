...
class LivePhotosList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['live_photos'] === null) {
            $invalidProperties[] = "'live_photos' can't be null";
        }
     ...
     * Sets live_photos
     *
     * @param \Onfido\Model\LivePhoto[] $live_photos live_photos
     *
     * @return self
     */
