...
/**
 * SigningDocument Class Doc Comment
 *
 * @category Class
 * @package  Onfido
 * @author   OpenAPI Generator team
 ...
 */
class SigningDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'signing_document';
    ...
    */
     ...
     * Sets applicant_id
     *
     * @param string|null $applicant_id The ID of the applicant whose signing document is being uploaded.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id The unique identifier for the signing document
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The date and time at which the signing document was uploaded
     *
     * @return self
     */
     ...
     * Sets download_href
     *
     * @param string|null $download_href The uri that can be used to download the signing document
     *
     * @return self
     */
